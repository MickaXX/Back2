...
<!-- Mirrored from html.nkdev.info/youplay/anime/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 May 2016 12:41:01 GMT -->
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/youplay/css/youplay-anime.min.css') }}" />

  <!-- Custom Styles -->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/custom.css') }}" />
  <!-- RTL (uncomment this to enable RTL support) -->
  <!-- <link rel="stylesheet" type="text/css" href="{{ asset('assets/youplay/css/youplay-rtl.css') }}" /> -->
    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li>
            <a href="index-2.html#screenshots">Screenshots</a>
          </li>
          <li>
            <a href="index-2.html#about">About</a>
          </li>
          <li>
            <a href="index-2.html#testimonials">Testimonials</a>
          </li>
          <li>
            <a href="index-2.html#news">News</a>
          </li>
          <li>
            <a href="index-2.html#exclusive">Exclusive</a>
          </li>
        </ul>
      </div>
    </div>
